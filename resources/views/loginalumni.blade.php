...
<!-- Mirrored from themesdesign.in/jobcy/layout/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Oct 2023 14:09:06 GMT -->
<head>
                                        ...
                                        <div class="row g-0">
                                            <div class="col-lg-6 text-center">
                                                <div class="card-body p-4">
                                                    ...
                                                    <div class="mt-5">
                                                        <img src="assets/images/log.png" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-lg-6">
                                                <div class="auth-content card-body p-5 h-100 text-white">
                                                    <div class="w-100">
                                                        <div class="text-center mb-4">
                                                            ...
                                                            <p class="text-white-70">Masuk untuk melanjutkan ke aplikasi.</p>
                                                        </div>
                                                        <form class="auth-form" method="POST" action='{{ url('auth')}}'  >                               
                                                            @csrf
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="text-center">
                                                                <button type="submit" class="btn btn-white btn-hover w-100">Masuk</button>
                                                            </div>
                                                        </form>

                
                                                        <div class="mt-4 text-center">
                                                            <p class="mb-0">Belum punya akun ? <a href="{{url('register')}}" class="fw-medium text-white text-decoration-underline">daftar</a></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!--end col-->
