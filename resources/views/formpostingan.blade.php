           ...
           <div class="card-header text-center">
               ...
               <div class="mb-3">   
                ...
                <label for="" class="form-label">Alamat</label>
                    <div class="mb-3">   
                      <textarea name="alamat" id="" cols="100" rows="10" >{{ old('alamat', $postingans->alamat)}}</textarea>
                </div>
             <div class="mb-3">   
             ...
             <div class="mb-3">   
               ...
               <select name="status" class="form-control" id="floatingSelect" aria-label="Floating label select example">
                 <option data-display = "status">Status</option>
                 @foreach($status as $statuses)
                 <option value="{{$statuses}}" {{ $postingans->status == $statuses ? 'selected' : ''}}>{{$statuses}}</option>
                @endforeach
               </select>
            </div>
                <div class="mb-3">
