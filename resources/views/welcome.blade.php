...
<!-- Mirrored from demo.epic-webdesign.com/tf-getleads/v5/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Dec 2023 12:55:51 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link href="/page/css/style-magnific-popup.css" rel="stylesheet">

    <!-- Awsome Fonts -->
    <link rel="stylesheet" href="/page/css/all.min.css">
    ...
    <!-- Font Favicon -->
    <link rel="shortcut icon" href="/page/images/bkk.png">
...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar navbar-expand-lg navbar-default navbar-fixed-top">
            ...
            <div class="container">
                    ...
                    <!--begin logo -->
                    <a class="navbar-brand" href="#">BKK SMK YPC</a>
                    <!--end logo -->
                    ...
                    <div class="d-grid d-md-none d-xl-flex gap-15 gap-xl-0 order-3">
                        <a href="{{url('loginalumni')}}"  ><button class="btn-red fw-semibold py-12 px-xl-34 ms-xl-12 rounded-pill" type="submit">Log In</button></a>
                    </div>
                    <!--end navbar-collapse -->
    ...
    <section class="home-section" id="home">
		...
		<div class="container">
	        ...
	        <div class="row align-items-center">
                ...
                <!--begin col-md-12-->
                <div class="col-md-12 margin-top-50 py-5">

                    <h1>Selamat Datang Di BKK SMK YPC Tasikmalaya</h1>

                    <p class="hero-text">Temukan Pekerjaan sesuai keinginanmu</p>

                    <a href="#about" class="btn-white-border scrool">Temukan Lainnya</a>

                    <a href="#portfolio" class="btn-white scrool">Posting pekerjaan Baru</a>
        ...
        <img src="/page/images/about05.png" class="width-50" alt="image">
		<!--end container -->
    ...
    <section class="section-grey">
        <center><h2 class="section-title">Tentang Kami</h2></center>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 padding-bottom-30 wow slideInLeft" data-wow-delay="0.25s" style="visibility: visible; animation-delay: 0.25s; animation-name: slideInLeft;">
                    ...
                    <img src="/page/images/bkk.png" class="width-100 bottom-margins-images" alt="pic">
                ...
                <div class="col-md-6">
                    ...
                    <p>Bursa Kerja Khusus (BKK) adalah sebuah lembaga yang dibentuk di Sekolah Menengah Kejuruan Negeri dan Swasta, sebagai unit pelaksana yang memberikan pelayanan dan informasi lowongan kerja, pelaksana pemasaran, penyaluran dan penempatan tenaga kerja, merupakan mitra Dinas Tenaga Kerja dan Transmigrasi.
    ...
    <section class="section-white"  >
        <center><h2 class="section-title">Tujuan</h2></center>
                    ...
                    <div class="nav flex-column nav-pills margin-right-25" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">
                            ...
                            <div class="features-second">
                                ...
                                <h4 class="margin-bottom-5">1</h4>

                                <p>Sebagai wadah dalam mempertemukan Alumni dengan pencari kerja.</p>
                        ...
                        <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">
                            ...
                            <div class="features-second">
                                ...
                                <h4 class="margin-bottom-5">2</h4>

                                <p>Memberikan layanan kepada Alumni sesuai dengan tugas dan fungsi masing-masing seksi yang ada dalam BKK.</p>
                        ...
                        <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">
                            ...
                            <div class="features-second">
                                ...
                                <h4 class="margin-bottom-5">3</h4>

                                <p>Sebagai wadah dalam pelatihan Alumni yang sesuai dengan permintaan pencari kerja.</p>
                ...
                <div class="col-md-6 padding-bottom-30">
                    ...
                    <div class="tab-content margin-left-20" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <img src="/page/images/about04.png" class="width-100 top-margins-images" alt="pic">
                        </div>

                        <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab"> 
                            <img src="/page/images/about05.png" class="width-100 top-margins-images" alt="pic">
                        </div>

                        <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                            <img src="/page/images/about06.png" class="width-100 top-margins-images" alt="pic">
                        </div>
 ...
 <div class="partners-section mt-5 py-5" id="team">
        <center><h2>Perusahaan</h2></center>
    <!--begin container-->
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-10 mx-auto text-center partners">
                ...
                <img src="/storage/{{$item->foto_perusahaan}}" class="partners" alt="image" width="150">
...
<!--end partners-section-->
    ...
    <section class="section mt-5 py-5 " id="testimonials">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5 col-sm-12">
                    ...
                    <p>Berikut adalah review/testimoni dari beberapa pengguna yang telah menggunakan website kami</p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-header" id="headingOne">
                                ...
                                <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                  <img src="/storage/{{$item->foto_testi}}" alt="testimonials" class="testim-img">
                                  <p class="testim-name">{{$item->nama_testi}}</p>
                                </button>
                                </h5>
                                @endforeach
                            </div>
                ...
                <div class="col-md-4 col-sm-12 p-0 m-0">
                    ...
                    <figure class="gallery-insta">
                        ...
                        <div class="popup-gallery popup-gallery-rounded portfolio-pic">
                            <a class="popup2" href="/page/images/gallery1.jpg">
                                <img src="/page/images/gallery1.jpg" class="width-100" alt="pic">
                    ...
                    <figure class="gallery-insta">
                        <!--begin popup-gallery-->
                        <div class="popup-gallery popup-gallery-rounded portfolio-pic">
                            <a class="popup2" href="/page/images/gallery2.jpg">
                                <img src="/page/images/gallery2.jpg" class="width-100" alt="pic">
                                <span class="eye-wrapper"><i class="fa fa-search-plus eye-icon" style="font-size: 38px;"></i></span>
                            </a>
                        </div>
                        <!--end popup-gallery-->
                ...
                <div class="newsletter_box">
                  ...
                  <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <img src="/page/images/about06.png" class="width-100 bottom-margins-images" alt="pic">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="newsletter_info">
                                ...
                                <h2>Anda sudah memiliki Akun?</h2>
                                   <h2>Anda bisa Menambahkan Lowongan Pekerjaan Sendiri </h2>
                                <!--begin success_box -->
                                {{-- <p class="newsletter_success_box" style="display:none;">We received your message and you'll hear from us soon. Thank You!</p> --}}
                                <!--end success_box -->
                                
                                <!--begin newsletter-form -->
                                {{-- <form id="newsletter-form" class="newsletter_form" action="https://demo.epic-webdesign.com/tf-getleads/v5/php/newsletter.php" method="post">
                                    <input id="email_newsletter" name="nf_email" placeholder="Enter Your Email Address" type="email">  
                                    <input value="Postingan Baru" id="submit-button-newsletter" type="submit">
                                </form> --}}
                                <div class="d-grid d-md-none d-xl-flex gap-15 gap-xl-0 order-3">
                                    <a href="{{url('datapostingan')}}"  ><button class="btn-red fw-semibold py-12 px-xl-34 ms-xl-12 " type="submit">Postingan Baru</button></a>
                                </div>
                                <!--end newsletter-form -->
                    ...
                    <div class="blog-item">
                        ...
                        <div class="popup-wrapper">
                            ...
                            <div class="popup-gallery">
                                <a href="#">
                                    <img src="/storage/{{$item->foto}}" alt="pic">
                        ...
                        <div class="blog-item-inner">
                            ...
                            <p class="blog-title text-dark">{{$item->nama_perusahaan}}</a></p>
                            
                            <a href="#" class="blog-icons last"><i class="far fa-clock"></i> {{$item->tanggal_post}}</a>
                            
                            <p>{{$item->deskripsi}}</p>
                            
                            @endforeach
                            <div class="d-grid d-md-none d-xl-flex gap-15 gap-xl-0 order-3">
                                <a href="{{url('detail')}}"  ><button class="btn-red fw-semibold py-12 px-xl-34 ms-xl-12 " type="submit">DEtail</button></a>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <!-- Tombol-tombol lain jika diperlukan -->
                                        </div>
                                    </div>
                                </div>
                            </div> --}}
                ...
                <div class="col-md-8 text-center margin-top-10">
                    ...
                    <div class="contact-form-wrapper wow bounceIn" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: bounceIn;">
                        ...
                        <div>
                            ...
                            <!--begin contact form -->
                            <form id="contact-form" class="row contact-form contact" action="https://demo.epic-webdesign.com/tf-getleads/v5/php/contact.php" method="post">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input value="Kirim" class="contact-submit" type="submit">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <p>© 2020 <span class="template-name">Loker</span>. Designed by <a href="https://themeforest.net/user/epic-themes/portfolio?ref=Epic-Themes" target="_blank">Loker</a></p>
...
<script src="/page/js/jquery.scrollTo-min.js"></script>
...
<!-- Mirrored from demo.epic-webdesign.com/tf-getleads/v5/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Dec 2023 12:56:06 GMT -->
</html>