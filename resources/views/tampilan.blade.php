...
<main class="main">
			...
			<div class="row">
					...
					<div class="swiper header-slider">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<h1 class="heading-header-1 mb-0">Selamat datang <span class="text-primary">Di website </span> Informasi Lowongan Pekerjaan 	</h1>
						...
						<div class="d-flex flex-wrap align-items-center mt-60 gap-20">
							...
							<a class="d-flex align-items-center fw-medium text-dark text-decoration-none" data-fslightbox="gallery" href="https://www.youtube.com/embed/pj5LRL3nwBg">
								<div href="#" class="btn btn-rounded btn-white border border-alice-blue">
									<img src="asset/icons/play-stroke.svg" class="svg-inject svg-icon text-primary is-20" alt="" />
								</div>
				...
				<div class="col-12 col-lg-6 col-xl-7 order-1 order-lg-2">
					<div class="position-relative h-lg-100">
						<img src="asset/pages/index/header/heroImage.png" class="hero-image-img" alt="" />
						<!-- /. hero-image -->
					</div>
				</div>
				<!-- /.col -->
	...
	<div class="container py-60 py-lg-100">
		<div class="swiper image-slider client-logo-slider mx-xl-34 mx-xxl-80">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<img src="asset/client-logo/client-logo-1.png" alt="" />
				</div>

				<div class="swiper-slide">
					<img src="asset/client-logo/client-logo-2.png" alt="" />
				</div>

				<div class="swiper-slide">
					<img src="asset/client-logo/client-logo-3.png" alt="" />
				</div>

				<div class="swiper-slide">
					<img src="asset/client-logo/client-logo-4.png" alt="" />
				</div>

				<div class="swiper-slide">
					<img src="asset/client-logo/client-logo-5.png" alt="" />
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-12 col-lg-6 col-xxl-5 order-2 order-lg-1">
				{{-- <div class="d-grid gap-12 w-md-75 w-lg-100"> --}}
					<div class="container-xxl py-60" id="tentang">
			...
			<div class="col-12 col-lg-6 offset-xxl-1 d-flex align-items-end mb-34 mb-lg-0 order-1 order-lg-2">
				<div class="position-relative">
					<img src="asset/pages/index/how-it-work/background.png" class="how-it-work-image-img rounded-40" alt="" />
					<img src="asset/pages/index/how-it-work/figure-1.svg" class="svg-inject position-absolute how-it-work-figure-1" alt="" />
					<img src="asset/pages/index/how-it-work/figure-2.svg" class="svg-inject position-absolute how-it-work-figure-2" alt="" />
					<img src="asset/pages/index/how-it-work/figure-3.svg" class="svg-inject position-absolute how-it-work-figure-3" alt="" />
				</div>
			</div>
			<!-- /.col -->
		</div>
			...
			<div class="col-12 col-md-6 col-lg-4 my-12">
				<div class="card card-icon">
					<div class="card-box-icon bg-outrageous-orange text-white">
						<img src="asset/icons/compas.svg" class="svg-inject svg-icon" alt="" />
					</div>
	...
	<div class="container-xxl py-60">
		...
		<div class="position-relative profile-card-slider mt-lg-25">
				...
				<div class="swiper-wrapper">
						...
						<div class="profile-card-slide">
							<div class="d-flex">
								<div class="profile-image">
									<img src="asset/profile-avatar/avatar-1.jpg" alt="" />
							...
							<div class="profile-action">
								<div class="profile-rating">
									<div class="profile-rating-icon">
										<img src="asset/icons/star.svg" class="svg-inject svg-icon checked" alt="" />
										<img src="asset/icons/star.svg" class="svg-inject svg-icon checked" alt="" />
										<img src="asset/icons/star.svg" class="svg-inject svg-icon checked" alt="" />
										<img src="asset/icons/star.svg" class="svg-inject svg-icon checked" alt="" />
										<img src="asset/icons/star.svg" class="svg-inject svg-icon" alt="" />
									</div>
					...
					<div class="swiper-slide">
						<div class="profile-card-slide">
							<div class="d-flex">
								<div class="profile-image">
									<img src="assets/profile-avatar/avatar-2.jpg" alt="avatar-2" />
									<div class="profile-online-status online"></div>
								</div>
								<div class="d-flex flex-column justify-content-center">
									<h6 class="profile-name">
					...
					<div class="swiper-slide">
						<div class="profile-card-slide">
							<div class="d-flex">
								<div class="profile-image">
									<img src="asset/profile-avatar/avatar-3.jpg" alt="avatar-3" />
					...
					<div class="swiper-slide">
						<div class="profile-card-slide">
							<div class="d-flex">
								<div class="profile-image">
									<img src="asset/profile-avatar/avatar-4.jpg" alt="avatar-4" />
									<div class="profile-online-status online"></div>
								</div>
								<div class="d-flex flex-column justify-content-center">
									<h6 class="profile-name">
			...
			<div class="profile-card-button-next">
				<img src="asset/icons/long-arrow-right.svg" class="svg-inject svg-icon" alt="" />
			</div>
			<!-- /.profile-slider-btn-next -->

			<div class="profile-card-button-prev">
				<img src="asset/icons/long-arrow-left.svg" class="svg-inject svg-icon" alt="" />
			</div>
	...
	<div class="container-xxl py-60">
		...
		<div class="row">
				...
				<div class="job-card-grid mx-xxl-15">
					<div class="job-dropdown">
						<button class="job-dropdown-btn" type="button" id="job-featured-dropdown" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="asset/icons/ellipsis.svg" class="svg-inject svg-icon" alt="" />
						</button>
					...
					<div class="job-info">
						<div class="job-image">
							<img src="asset/job-logo/job-logo-1.png" alt="" />
						</div>
						<h5 class="job-title">
					...
					<ul class="job-detail">
						<li class="job-detail-item">
							<div class="job-detail-start">
								<img src="asset/icons/sack-dollar.svg" class="svg-inject svg-icon" alt="" />
							</div>
						...
						<li class="job-detail-item">
							<div class="job-detail-start">
								<img src="asset/icons/mark.svg" class="svg-inject svg-icon" alt="" />
							</div>
							<div class="job-detail-center">
					...
					<div class="job-action">
						<button class="btn btn-rounded btn-book">
							<img src="asset/icons/heart.svg" class="svg-inject svg-icon" alt="" />
						</button>
			...
			<div class="col-12 col-md-4 col-xxl-3 my-12">
				<div class="job-card-grid mx-xxl-15">
					...
					<div class="job-info">
						<div class="job-image">
							<img src="asset/job-logo/job-logo-2.png" alt="" />
						</div>
						<h5 class="job-title">
			...
			<div class="col-12 col-md-4 col-xxl-3 my-12">
				<div class="job-card-grid mx-xxl-15">
					...
					<div class="job-info">
						<div class="job-image">
							<img src="asset/job-logo/job-logo-3.png" alt="" />
						</div>
						<h5 class="job-title">
			...
			<div class="d-none d-xxl-block col-xxl-3 my-12">
				<div class="job-card-grid mx-xxl-15">
					<div class="job-dropdown">
						<button class="job-dropdown-btn" type="button" id="job-featured-dropdown" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="asset/icons/ellipsis.svg" class="svg-inject" alt="" />
						</button>
						<ul class="dropdown-menu dropdown-menu-end" aria-labelledby="job-featured-dropdown">
							<li><a class="dropdown-item" href="#">Dropdown 1</a></li>
							<li><a class="dropdown-item" href="#">Dropdown 2</a></li>
					...
					<div class="job-info">
						<div class="job-image">
							<img src="asset/job-logo/job-logo-4.png" alt="" />
						</div>
						<h5 class="job-title">
							<a href="jobdetail.html">Database Programmer</a>
						</h5>
		...
		<div class="d-flex">
			<a class="btn btn-primary fw-semiBold py-12 px-43 mt-60 mx-auto rounded-pill" href="joblist.html" role="button">View more</a>
		</div>
		<!-- /.btn-more -->
	</div>
	<!-- /.container -->
		...
		<div class="testimonial-slider w-xl-85 mx-auto">
			<div class="testimonial-slider-image">
				<div class="swiper">
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<img src="asset/profile-avatar/avatar-5.jpg" alt="" />
						</div>
						<div class="swiper-slide">
							<img src="asset/profile-avatar/avatar-6.jpg" alt="" />
						</div>
					</div>
				</div>

				<img src="asset/pages/index/testimonial/figure-1.svg" class="svg-inject position-absolute testimonial-figure-1 text-dark z-index-1" alt="" />

				<img src="asset/pages/index/testimonial/figure-2.svg" class="svg-inject position-absolute testimonial-figure-2 text-primary z-index-1" alt="" />
			</div>
			...
			<div class="swiper testimonial-slider-content">
				...
				<div class="testimonial-footer">
					...
					<div class="avatar-group">
						...
						<div class="avatar" href="#">
							<img src="asset/profile-avatar/avatar-7.jpg" alt="" />
						</div>
						<div class="avatar" href="#">
							<img src="asset/profile-avatar/avatar-8.jpg" alt="" />
						</div>
						<div class="avatar" href="#">
							<img src="asset/profile-avatar/avatar-9.jpg" alt="" />
						</div>
	...
	<div class="container-xxl py-60">
		<div class="counter">
			...
			<figure>
				<img src="asset/pages/index/counter/figure-1.svg" class="svg-inject position-absolute figure-1 text-ocean-blue text-opacity-33" alt="" />

				<img src="asset/pages/index/counter/figure-2.svg" class="svg-inject position-absolute figure-2 text-majorelle-blue-200" alt="" />

				<img src="asset/pages/index/counter/figure-3.svg" class="svg-inject position-absolute figure-3 text-ocean-blue" alt="" />

				<img src="asset/pages/index/counter/figure-4.svg" class="svg-inject position-absolute figure-4 text-white" alt="" />

				<img src="asset/pages/index/counter/figure-5.svg" class="svg-inject position-absolute figure-5 text-majorelle-blue-200" alt="" />

				<img src="asset/pages/index/counter/figure-6.svg" class="svg-inject position-absolute figure-6 text-white text-opacity-17" alt="" />
			</figure>
		</div>
		<!-- /.counter-component -->
	</div>
	...
	<div class="container-xxl py-60" id="pricing-section">
		<div class="d-grid gap-12 w-md-50 w-xl-34 mb-60 mx-auto">
					...
					<ul class="pricing-detail">
						<li class="pricing-detail-item">
							<div class="pricing-detail-icon">
								<img src="asset/icons/check-circle.svg" class="svg-inject svg-icon" alt="" />
							</div>
			...
			<div class="swiper-wrapper">
				<div class="swiper-slide blog-item">
					<div class="blog-item-inner">
						...
						<div class="blog-thumb">
							...
							<img src="asset/blog-thumb/post-thumb-1.png" alt="" />
						</div>
				...
				<div class="swiper-slide blog-item">
					<div class="blog-item-inner">
						...
						<div class="blog-thumb">
							<div class="overlay"></div>
							<img src="asset/blog-thumb/post-thumb-2.png" alt="" />
						</div>
						<div class="blog-content">
							<div class="blog-meta">
								<a class="blog-meta-link author" href="#">James</a>
				...
				<div class="swiper-slide blog-item">
					<div class="blog-item-inner">
						...
						<div class="blog-thumb">
							<div class="overlay"></div>
							<img src="asset/blog-thumb/post-thumb-1.png" alt="thumb-1" />
						</div>
						<div class="blog-content">
							<div class="blog-meta">
								<a class="blog-meta-link author" href="#">James</a>
