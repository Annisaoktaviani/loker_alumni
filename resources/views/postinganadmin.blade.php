                ...
                <div class="body">
                    <div class="table-responsive">
                        ...
                        <tr class="bg-white border-b border-dashed dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                <a href="postinganadmin/edit/{{$item-> id_postingan}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                <a href= "postinganadmin/delete/{{$item-> id_postingan}}"class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a>
                        </tr>
                        @endforeach
                            </tbody>
                        </table>
