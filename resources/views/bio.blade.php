...
<head>
    ...
    <!--Material Icon -->
    <link rel="/form/stylesheet" type="text/css" href="/form/css/materialdesignicons.min.css" />

    <link rel="/form/stylesheet" type="text/css" href="/form/css/fontawesome.css" />

    <!-- selectize css -->
    <link rel="/form/stylesheet" type="text/css" href="/form/css/selectize.css" />

    <link rel="/form/stylesheet" type="text/css" href="/form/css/nice-select.css" />

    <!-- Custom  Css -->
    <link rel="/form/stylesheet" type="text/css" href="/form/css/style.css" />
...
<body>
    ...
    <script src="/form/js/bootstrap.bundle.min.js"></script>
    <script src="/form/js/jquery.easing.min.js"></script>
    <script src="/form/js/plugins.js"></script>

    <!-- selectize js -->
    <script src="/form/js/selectize.min.js"></script>

    <script src="/form/js/jquery.nice-select.min.js"></script>
