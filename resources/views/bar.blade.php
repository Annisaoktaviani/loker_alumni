    ...
    <div class="container-fluid px-0">
        ...
        <div id="navbar_main">
            <ul class="navbar-nav mr-auto hidden-xs">
                ...
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('dashboardadmin')}}"><i class="fa fa-home"></i></a></li>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="{{url('user/logout')}}"><i class="fa fa-sign-out text-primary"></i>Keluar</a>
                        {{-- <li>
                            <form action="{{url('user/logout')}}" method="post">
                                @csrf
                                <a href="{{url('user/logout')}}"><i class="fa fa-sign-out text-primary"></i><span>Keluar</span></a>
                            </form>
                        </li> --}}
                    </div>
                </li>
    ...
    <div class="left_sidebar">
        <nav class="sidebar">
            ...
            <ul id="main-menu" class="metismenu">
                ...
                <li><a href="{{url('dashboardadmin')}}"><i class="ti-home text-primary"></i><span>Dashboard</span></a></li>
                ...
                <li><a href="{{url('postingan')}}"><i class="ti-comments text-primary"></i><span>Data Postingan</span></a></li>
                <li><a href="{{url('pengajuan')}}"><i class="ti-pencil-alt text-primary"></i><span>Data Pengajuan</span></a></li>
                <li><a href="{{url('perusahaan')}}"><i class="ti-id-badge text-primary"></i><span>Data Perusahaan</span></a></li>
                <li>
                    <form action="{{url('user/logout')}}" method="post">
                        @csrf
                        <a href="{{url('user/logout')}}"><i class="fa fa-sign-out text-primary"></i><span>Keluar</span></a>
