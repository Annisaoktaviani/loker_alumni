...
<!-- Mirrored from www.wrraptheme.com/templates/bigbucket/html/light/table-datatable.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Nov 2023 11:28:39 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="/dasboard/assets/vendor/jquery-datatable/dataTables.bootstrap4.min.css">

    <link  rel="stylesheet" href="/dasboard/assets/css/main.css">
</head>
<body class="theme-indigo">
    ...
    <nav class="navbar custom-navbar navbar-expand-lg py-2">
        <div class="container-fluid px-0">
            ...
            <a href="index.html" class="navbar-brand"><img src="https://www.wrraptheme.com/templates/bigbucket/html/assets/images/brand/icon.svg" alt="BigBucket" />
    ...
    <div class="main_content" id="main-content">
        <div class="left_sidebar">
            <nav class="sidebar">
                <div class="user-info">
                    <div class="image"><a href="javascript:void(0);"><img src="/dasboard/assets/images/user.png" alt="User"></a></div>
                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li class="active">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="table-datatable.html">Jquery Datatable</a></li>
                    ...
                    <li><a href="https://www.wrraptheme.com/templates/bigbucket/html/docs/introduction.html"><i class="ti-file"></i><span>Documentation</span></a></li>
                </ul>
            </nav>
        </div>
                        ...
                        <ul class="list-unstyled contact-list">
                            <li class="d-flex align-items-center">
                                <span class="contact-img">
                                    <img src="/dasboard/assets/images/xs/avatar1.jpg" class="rounded" alt="">
                                </span>
                            ...
                            <li class="d-flex align-items-center">
                                <span class="contact-img">
                                    <img src="/dasboard/assets/images/xs/avatar2.jpg" class="rounded" alt="">
                                </span>
                            ...
                            <li class="d-flex align-items-center">
                                <span class="contact-img">
                                    <img src="/dasboard/assets/images/xs/avatar3.jpg" class="rounded" alt="">
                                </span>
                            ...
                            <li class="d-flex align-items-center">
                                <span class="contact-img">
                                    <img src="/dasboard/assets/images/xs/avatar4.jpg" class="rounded" alt="">
                                </span>
                            ...
                            <li class="d-flex align-items-center">
                                <span class="contact-img">
                                    <img src="/dasboard/assets/images/xs/avatar5.jpg" class="rounded" alt="">
                                </span>
                            ...
                            <li class="d-flex align-items-center">
                                <span class="contact-img">
                                    <img src="/dasboard/assets/images/xs/avatar6.jpg" class="rounded" alt="">
                                </span>
                                <h4 class="contact-name">Aiden Chavaz</h4>
                                <div class="action">
                                    <a href="javascript:void(0);" class="btn btn-sm btn-outline-primary"><i class="fab fa-skype"></i></a>
                            ...
                            <li class="d-flex align-items-center">
                                <span class="contact-img">
                                    <img src="/dasboard/assets/images/xs/avatar7.jpg" class="rounded" alt="">
                                </span>
                            ...
                            <li class="d-flex align-items-center">
                                <span class="contact-img">
                                    <img src="/dasboard/assets/images/xs/avatar8.jpg" class="rounded" alt="">
                                </span>
                                <h4 class="contact-name">Aiden Chavaz</h4>
                                <div class="action">
                                    <a href="javascript:void(0);" class="btn btn-sm btn-outline-primary"><i class="fab fa-skype"></i></a>
